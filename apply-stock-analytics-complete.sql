...
-- Step 1: Add product_name column to facility_deliveries
-- =============================================
DO $$
BEGIN
  IF NOT EXISTS (
    ...
    AND table_name = 'facility_deliveries'
    AND column_name = 'product_name'
  ) THEN
    ALTER TABLE public.facility_deliveries
    ADD COLUMN product_name TEXT;

    CREATE INDEX IF NOT EXISTS idx_facility_deliveries_product_name
...
-- =============================================
-- Purpose: Provide comprehensive stock analytics including status,
--          balance (allocated vs available), performance metrics,
--          zone-based distribution, and low stock alerts
-- Date: 2026-01-01
-- =============================================
...
-- =============================================
-- Public Schema Wrappers with SECURITY DEFINER
-- =============================================
