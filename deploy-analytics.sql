...
-- This script creates the entire analytics infrastructure that was missing.
--
-- What it creates:
--   1. analytics schema
--   2. system_settings table (for cost rates)
--   3. 4 materialized views (delivery_performance, driver_efficiency,
--      vehicle_utilization, cost_analysis)
--   4. Refresh triggers for automatic mat view updates
--   5. Analytics KPI functions (in analytics schema)
--   6. Public wrapper functions (called by PostgREST)
--   7. Permissions
-- ===========================================================================

-- ===========================================================================
-- STEP 1: CLEAN SLATE - Drop any partial objects
-- ===========================================================================
...
-- ===========================================================================
-- STEP 6: CREATE ANALYTICS KPI FUNCTIONS (with correct type casts)
-- ===========================================================================
...
-- ===========================================================================
-- STEP 9: REFRESH ALL MATERIALIZED VIEWS
-- ===========================================================================
...
BEGIN
  ...
  RAISE NOTICE '==================================================================';
  RAISE NOTICE 'ANALYTICS DEPLOYMENT COMPLETED SUCCESSFULLY';
  RAISE NOTICE '==================================================================';
  ...
  RAISE NOTICE '';
  RAISE NOTICE 'Functions created: 10 analytics + 10 public wrappers';
  RAISE NOTICE 'Triggers configured for automatic refresh';
  RAISE NOTICE '==================================================================';
END $$;
