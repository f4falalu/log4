-- ============================================================================
-- Analytics Test Data - WORKING VERSION
-- Creates sample delivery batches matching actual schema
-- Uses non-concurrent refresh for cost_analysis view
-- ============================================================================
...
-- NOTE: cost_analysis doesn't support CONCURRENTLY (single-row aggregate)
-- ============================================================================
