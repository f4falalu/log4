-- ============================================================================
-- Fix create_organization_with_admin: respect user status state machine
-- ============================================================================
-- The user status trigger enforces: registered → role_assigned → active
-- The RPC was jumping straight to 'active', skipping 'role_assigned'.
-- ============================================================================
