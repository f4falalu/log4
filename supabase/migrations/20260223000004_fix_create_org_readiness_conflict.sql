-- ============================================================================
-- Fix create_organization_with_admin: handle workspace_readiness conflict
-- ============================================================================
-- Issue: The member_readiness_trigger on workspace_members fires AFTER INSERT
-- and inserts into workspace_readiness. The RPC then tries to insert again,
-- causing "duplicate key value violates unique constraint" error.
-- Fix: Add ON CONFLICT (workspace_id) DO UPDATE to the readiness insert.
-- ============================================================================
