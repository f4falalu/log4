-- ============================================================================
-- Fix create_organization_with_admin: use role_id instead of role text
-- ============================================================================
-- Issue: The RPC inserts into user_roles with only (user_id, role, assigned_by)
-- but migration 20260221170001 made role_id NOT NULL (FK to roles table).
-- Fix: Look up the system_admin role UUID from the roles table and set role_id.
-- ============================================================================
