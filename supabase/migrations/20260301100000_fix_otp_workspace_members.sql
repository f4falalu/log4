-- ============================================================================
-- Fix verify_mod4_otp and link_user_to_mod4: add workspace_members record
-- ============================================================================
-- Issue: After OTP verification, drivers don't appear in BIKO's integration
-- page because get_mod4_linked_users() INNER JOINs on workspace_members,
-- but the OTP flow never inserts a workspace_members record.
-- Fix: Extract workspace_id from the OTP record and insert into workspace_members.
-- ============================================================================
...
-- =========================
-- Note: link_user_to_mod4 doesn't have workspace_id context directly,
-- so we add an optional parameter for it.
DROP FUNCTION IF EXISTS public.link_user_to_mod4(UUID, TEXT);
