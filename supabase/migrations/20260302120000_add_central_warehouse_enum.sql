-- ============================================================================
-- Replace bulk_insert_facilities with per-row error handling.
-- Each row is inserted individually so one bad row doesn't kill the batch.
-- Returns inserted_count, failed_count, and error_message (summary).
-- Type column is omitted — DB default 'clinic' applies. User can update later.
-- ============================================================================
...
BEGIN
  ...
  LOOP
    ...
    EXCEPTION WHEN OTHERS THEN
      _failed := _failed + 1;
      -- Keep first 20 error messages to avoid huge payloads
