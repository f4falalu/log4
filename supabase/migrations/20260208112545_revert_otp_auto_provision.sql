-- =====================================================
-- Revert auto-provisioning from verify_mod4_otp
-- =====================================================
-- Direct INSERT into auth.users causes GoTrue 500 errors because
-- it bypasses GoTrue's user creation pipeline. User creation is now
-- handled by the generate-driver-otp Edge Function via GoTrue Admin API.
...
BEGIN
  ...
  ELSE
    ...
    -- Find user by email (must already exist — created by Edge Function)
