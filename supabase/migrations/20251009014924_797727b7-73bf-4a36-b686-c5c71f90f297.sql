-- Fix search_path security issue in setup_test_admin function
DROP FUNCTION IF EXISTS public.setup_test_admin();
...
BEGIN
  ...
  IF test_user_id IS NOT NULL THEN
    ...
    VALUES (test_user_id, 'system_admin'::public.app_role)
