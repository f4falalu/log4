...
-- WITH TABLE CREATION
-- =============================================
-- This script creates all necessary tables and analytics functions
-- Execute this entire file in Supabase SQL Editor
-- =============================================

-- =============================================
-- STEP 1: Create facility_stock table
-- =============================================
...
-- Create indexes for facility_stock
...
COMMENT ON TABLE public.facility_stock IS 'Current stock levels at each facility';
COMMENT ON COLUMN public.facility_stock.product_name IS 'Product name for analytics and reporting';
COMMENT ON COLUMN public.facility_stock.quantity IS 'Current quantity in stock';

-- =============================================
-- STEP 2: Create facility_deliveries table
-- =============================================
...
-- Create indexes for facility_deliveries
...
-- =============================================
-- STEP 3: Stock Analytics Functions
-- =============================================
...
BEGIN
  ...
  RAISE NOTICE '  - facility_stock table';
  RAISE NOTICE '  - facility_deliveries table';
  RAISE NOTICE '  - 5 analytics functions';
  RAISE NOTICE '  - 5 public wrappers';
  RAISE NOTICE '  - 10 performance indexes';
  RAISE NOTICE '';
  RAISE NOTICE 'Next: Test with SELECT * FROM get_stock_status();';
END $$;
