-- Fix Missing Resource Utilization Analytics Functions
-- This migration adds ONLY the missing functions for resource utilization
...
BEGIN
  ...
  SELECT
    ...
    ROUND((pc.fuel + pc.maint) / NULLIF
  (pc.fuel + pc.maint) / NULLIF(pc.deliveries, 0), 2) as cost_per_delivery,
